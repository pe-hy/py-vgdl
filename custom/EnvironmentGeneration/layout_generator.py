...
def generate_layout(graph_instances_lst, instances_num, MOL_IDX, num_columns, grid_size, min_room_size, test=False):
        for instance in range(instances_num):
            ...
            if test:
                ...
                filename = os.path.join(instances_folder, str(num_files) + "_generated_layout.txt")
